...
LANE_TEMPLATES = {
    ...
    "warehouse_logistics": {
        ...
        "keywords": ["warehouse associate", "forklift", "picker", "packer", "logistics", "shipping and receiving"],
    ...
    "retail_sales": {
        ...
        "keywords": ["retail associate", "sales associate", "cashier", "sales representative"],
        "required_keywords": None, "seniority_max": None, "sources": ["adzuna", "hiring_cafe", "greenhouse"],
    ...
    "food_service": {
        ...
        "keywords": ["cook", "server", "barista", "dishwasher", "line cook", "food service worker"],
        "required_keywords": None, "seniority_max": None, "sources": ["adzuna", "hiring_cafe", "greenhouse"],
    ...
    "administrative": {
        ...
        "keywords": ["administrative assistant", "office assistant", "data entry", "receptionist", "office coordinator"],
        "required_keywords": None, "seniority_max": None, "sources": ["adzuna", "hiring_cafe", "greenhouse"],
        "industries": [], "radius_km": None, "remote_types": [], "employment_types": [], "salary_min": None, "salary_max": None,
    },
    "healthcare_support": {
        "name": "healthcare_support", "label": "Healthcare Support", "resume": "resume_healthcare_support.json",
        "keywords": ["personal support worker", "healthcare aide", "home care worker", "care aide", "nursing assistant"],
        "required_keywords": None, "seniority_max": None, "sources": ["adzuna", "hiring_cafe", "greenhouse"],
    ...
    "skilled_trades": {
        ...
        "keywords": ["electrician", "plumber", "hvac technician", "welder", "mechanic", "carpenter"],
        "required_keywords": None, "seniority_max": None, "sources": ["adzuna", "hiring_cafe", "greenhouse"],
        "industries": [], "radius_km": 25.0, "remote_types": [], "employment_types": [], "salary_min": None, "salary_max": None,
    },
    "education_childcare": {
        "name": "education_childcare", "label": "Education / Childcare", "resume": "resume_education_childcare.json",
        "keywords": ["teacher", "teaching assistant", "early childhood educator", "tutor", "daycare"],
        "required_keywords": None, "seniority_max": None, "sources": ["adzuna", "hiring_cafe", "greenhouse"],
    ...
    "delivery_driver": {
        ...
        "keywords": ["delivery driver", "courier", "truck driver", "dispatcher"],
        "required_keywords": None, "seniority_max": None, "sources": ["adzuna", "hiring_cafe", "greenhouse"],
        "industries": [], "radius_km": 25.0, "remote_types": [], "employment_types": [], "salary_min": None, "salary_max": None,
    },
    "manufacturing": {
    ...
    "marketing_creative": {
        ...
        "keywords": ["marketing coordinator", "social media", "graphic designer", "content writer", "marketing assistant"],
        "required_keywords": None, "seniority_max": None, "sources": ["adzuna", "hiring_cafe", "greenhouse"],
        "industries": [], "radius_km": None, "remote_types": [], "employment_types": [], "salary_min": None, "salary_max": None,
    },
    "cleaning_janitorial": {
        "name": "cleaning_janitorial", "label": "Cleaning / Janitorial", "resume": "resume_cleaning_janitorial.json",
        "keywords": ["janitor", "custodian", "cleaner", "housekeeping", "maintenance worker"],
        "required_keywords": None, "seniority_max": None, "sources": ["adzuna", "hiring_cafe", "greenhouse"],
        "industries": [], "radius_km": 25.0, "remote_types": [], "employment_types": [], "salary_min": None, "salary_max": None,
    },
}
